...
export const Facilities = () => {
  ...
  return (
    <section
      id="facilities"
      className="relative flex min-h-screen w-full flex-col overflow-hidden bg-[#023020] desktop:h-screen"
    >
      ...
      {/* ── Header ── */}
      <div className="relative z-10 shrink-0 px-6 pt-16 md:px-12 md:pt-20 desktop:px-16">
        <motion.p
        ...
        <motion.h2
          className="font-playfair text-3xl text-[#F5F5EB] md:text-5xl desktop:text-6xl"
      ...
      {/* ═══════════════════════════════════════
         ...
         ═══════════════════════════════════════ */}
      <div className="relative z-10 mt-6 hidden min-h-0 flex-1 gap-3 px-6 pb-6 desktop:flex desktop:px-12 desktop:pb-12">
          ...
          return (
            ...
            >
              ...
              <AnimatePresence>
                {isActive && (
                  <motion.div
                    className="absolute bottom-0 left-0 right-0 flex flex-col justify-end p-8 desktop:p-10"
                  ...
                  >
                    ...
                    <h3 className="mb-3 font-playfair text-3xl text-[#F5F5EB] desktop:text-4xl">
                      {fac.title}
                    </h3>

                    <p className="mb-6 max-w-lg font-sans text-sm leading-relaxed text-[#F5F5EB]/75 desktop:text-base">
                      {fac.description}
                    </p>
      ...
      <div className="pointer-events-none absolute bottom-4 left-1/2 z-20 hidden -translate-x-1/2 gap-2 desktop:flex">
        {FACILITIES.map((_, i) => (
          <div
            key={i}
      ...
      {/* ═══════════════════════════════════════
         ...
         ═══════════════════════════════════════ */}
      <div className="relative z-10 mt-4 flex flex-1 flex-col gap-2.5 overflow-y-auto px-4 pb-4 desktop:hidden">
        {FACILITIES.map((fac, i) => {
