  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="font-playfair text-4xl text-[#023020] md:text-5xl desktop:text-6xl">
          Certifications
        </h2>
      ...
      <div className="mx-auto grid w-full max-w-5xl shrink-0 grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 md:gap-4 lg:grid-cols-5 desktop:grid-cols-7">
        {CERTS.map((cert, i) => (
          <motion.div
            key={cert.name}
